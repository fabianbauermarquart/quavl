...
class Circuit:
    ...
    def initialize_qbits(self, values: List[Union[Tuple[Union[int, complex], Union[int, complex]],
                                                  Set[Tuple[int, int]]]]):
        """
    ...
    def prove(self,
              ...
              entangling_gate_index: int = 0) -> Union[Tuple[str, collections.OrderedDict, float],
    ...
    def _prove_qbit_sequence_model(self,
        ...
        if self.final_qbits is not None and synthesize_repair is True:
            ...
            if entangling_repair is True:
                ...
                if len(self.qbits) != 3:
                    raise Error(f'Qbit count of {len(self.qbits)} is not supported.')
                ...
                if entangling_gates == 0:
                    ...
                    next_kron_state = complex_kron_n_ary([next_state[i].to_complex_list() for i in range(len(self.qbits))])
    ...
    def _prove_state_model(self,
                           ...
                           measurement_branch: int = None,
                           file_generation_only: bool = False,
                           synthesize_repair: bool = False) -> Union[Tuple[str, collections.OrderedDict, float],
                                                                     Tuple[NamedTemporaryFile, Set[str]]]:
        """
